...
### Potential Impact
 ...
 - `partial_update` also locally captured serializer validation errors, so the view was swallowing fault details before the global handler could annotate them.
