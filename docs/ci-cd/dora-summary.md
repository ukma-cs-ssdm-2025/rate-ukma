...
| Change Failure Rate | 100.0% | Low |
| Time to Restore | 2h 48m | High |

**Total Runs:** 2 | **Successful:** 0 (0.0%) | **Failed:** 2 (100.0%)
...
xychart-beta
    ...
    bar [7.82, 5.33, 4.93, 6.10, 9.94, 6.87, 8.39, 7.83, 8.96, 9.42, 7.58, 7.96, 7.80, 7.85]
```
...
xychart-beta
    ...
    bar [1.00, 5.00, 1.00, 3.00, 5.00, 4.00, 2.00, 1.00, 20.00, 1.00, 3.00, 13.00, 5.00, 2.00]
```

**Deployment Cadence Analysis:**
- **Average per week:** 4.7 deployments
...
xychart-beta
    ...
    x-axis ["Dec 22", "Dec 29", "Jan 05", "Jan 12", "Jan 26", "Feb 02", "Feb 16", "Feb 23", "Mar 02", "Mar 09", "Mar 16", "Mar 23", "Mar 30", "Apr 06", "Apr 13"]
    y-axis "Failure Rate (%)" 0 --> 100
    bar [0.00, 16.67, 0.00, 42.86, 12.50, 0.00, 0.00, 60.00, 25.93, 0.00, 12.50, 27.78, 16.67, 0.00, 100.00]
```
