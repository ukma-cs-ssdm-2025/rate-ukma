...
| Lead Time for Changes | 4m 56s | Elite |
...
xychart-beta
    ...
    x-axis ["Nov 17", "Nov 24", "Dec 01", "Dec 08", "Dec 15", "Dec 22", "Dec 29", "Jan 05"]
    y-axis "Duration (minutes)" 0 --> 10
    bar [5.52, 8.71, 4.08, 7.87, 6.60, 6.62, 5.33, 4.93]
```
...
xychart-beta
    ...
    bar [11.00, 9.00, 31.00, 11.00, 1.00, 4.00, 5.00, 1.00]
```

**Deployment Cadence Analysis:**
- **Average per week:** 9.1 deployments
...
xychart-beta
    ...
    bar [15.38, 25.00, 20.83, 20.00, 0.00, 0.00, 16.67, 0.00]
```
