    ...
    def handle(self, *args, **options):
        ...
        faculties_data = [
            ...
            },
            {
                ...
                "departments": ["Кафедра історії", "Кафедра філософії"],
            },
            {
                "name": "Факультет природничих наук",
                "departments": ["Кафедра біології", "Кафедра хімії"],
            },
            {
                "name": "Факультет соціальних наук і соціальних технологій",
                "departments": ["Кафедра соціології", "Кафедра політології"],
            },
            {
                "name": "Факультет охорони здоров`я, соціальної роботи і психології",
                "departments": ["Кафедра психології", "Кафедра соціальної роботи"],
            },
        ]
